...
def exec(individualsnf=sheetoperator.individualsnf, individualsf=sheetoperator.individualsf, individualspet=sheetoperator.individualspet, individualsgr=sheetoperator.individualsgr, equipsnf=sheetoperator.equipsnf, equipsf=sheetoperator.equipsf):
	...
	while i <=0:
		...
		rcontents.insert(14, str(nonetodash.nonetodash(sheetoperator.tot[eqfindex][7])))
		rcontents.insert(23, f'"t{i+1}"')
		rcontents.insert(49, str(nonetodash.nonetodash(sheetoperator.tot[eqfindex][2])))
		rcontents.insert(52, str(nonetodash.nonetodash(sheetoperator.tot[eqfindex][3])))
		rcontents.insert(55, str(nonetodash.nonetodash(sheetoperator.tot[eqfindex][4])))
		rcontents.insert(58, str(nonetodash.nonetodash(sheetoperator.tot[eqfindex][5])))
		rcontents.insert(61, str(nonetodash.nonetodash(sheetoperator.tot[eqfindex][6])))
		rcontents.insert(64, str(nonetodash.nonetodash(sheetoperator.tot[eqfindex][8])))
		write(rcontents)
		i += 1
	# PODOIUM CONTROL
