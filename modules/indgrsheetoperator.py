...
def exec(individualsnf=sheetoperator.individualsnf, individualsf=sheetoperator.individualsf, individualspet=sheetoperator.individualspet, individualsgr=sheetoperator.individualsgr, equipsnf=sheetoperator.equipsnf, equipsf=sheetoperator.equipsf):
	...
	while i <=2:
		...
		if sheetoperator.tot[indgrindex][8] == '':
			sheetoperator.tot[indgrindex][8] = ''
		else:
			sheetoperator.tot[indgrindex][8] = format(float(sheetoperator.tot[indgrindex][8]), '.2f')
			
		rcontents.insert(2, str(f'"{i+1}"'))
		rcontents.insert(9, str(nonetodash.nonetodash(sheetoperator.tot[indgrindex][1])))
		rcontents.insert(12, str(nonetodash.nonetodash(sheetoperator.tot[indgrindex][2])))
		rcontents.insert(16, str(nonetodash.nonetodash(sheetoperator.tot[indgrindex][8])))
		rcontents.insert(19, str(nonetodash.nonetodash(sheetoperator.tot[indgrindex][11])))
		rcontents.insert(28, f'"t{i+1}"')
		rcontents.insert(57, str(nonetodash.nonetodash(sheetoperator.tot[indgrindex][3])))
		rcontents.insert(60, str(nonetodash.nonetodash(sheetoperator.tot[indgrindex][4])))
		rcontents.insert(63, str(nonetodash.nonetodash(sheetoperator.tot[indgrindex][5])))
		rcontents.insert(66, str(nonetodash.nonetodash(sheetoperator.tot[indgrindex][6])))
		rcontents.insert(69, str(nonetodash.nonetodash(sheetoperator.tot[indgrindex][7])))
		rcontents.insert(72, str(nonetodash.nonetodash(sheetoperator.tot[indgrindex][10])))
		rcontents.insert(75, str(nonetodash.nonetodash(sheetoperator.tot[indgrindex][9])))
		write(rcontents)
		i += 1
	# PODOIUM CONTROL
